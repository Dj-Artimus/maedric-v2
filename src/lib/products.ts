...
const productImages = ['/images/product-1.png', '/images/product-2.png', '/images/product-3.png', '/images/product-4.png'];
...
const ringSizes = ['3.25', '4', '4.5', '5', '5.5', '6', '6.5', '7', '7.5', '8', '8.5', '9', '9.5', '10'];
  ...
  for (let i = 0; i < count; i++) {
    ...
    const stockCount = Math.random() < 0.1 ? Math.floor(Math.random() * 5) + 1 : undefined;
    ...
    const product: Product = {
      ...
      metalType,
      karat: metalType === 'gold' || metalType === 'silver' ? karatTypes[Math.floor(Math.random() * karatTypes.length)] : undefined,
      gemstoneUsage,
