  ...
  return (
    <section className="w-full md:max-w-4xl lg:max-w-6xl mx-auto px-4 sm:px-6 mt-[62px]">
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-14 lg:max-h-[650px] overflow-hidden">
        ...
        <div className="lg:max-h-[82%] hidden sm:flex flex-col justify-center mx-auto lg:justify-start items-center xs:max-w-sm sm:max-w-md md:max-w-xl md1:max-w-2xl lg:w-full sm:divide-y divide-black/20 overflow-auto scrollbar-primary">
        ...
        <div className="sm:hidden w-full overflow-hidden process-swiper">
          <Swiper
            ...
            className="w-full scrollbar-primary"
            onSwiper={(swiper) => {
