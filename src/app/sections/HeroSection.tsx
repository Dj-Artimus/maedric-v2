...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="w-full h-[85vh] md:h-[90vh] lg:h-[100vh] bg-primary/60 flex flex-col md:flex-row items-center justify-start relative scroll-smooth overflow-visible ">
      ...
      {/* Hero Content */}
      <div className="absolute w-full lg:w-[78%] bottom-0 left-1/2 -translate-x-1/2 inset-0 flex flex-col justify-center items-center px-4 sm:px-0 pt-16 pb-8 sm:pt-20 sm:pb-12 md:pb-16 xl:pb-24 overflow-visible">
        <div className="flex flex-col md:flex-row gap-[36px] items-center justify-between md:items-end w-full h-screen">
          ...
          >
            ...
            <div className=" flex flex-row justify-end items-center group-hover:animate-pulse">
